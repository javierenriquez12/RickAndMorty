...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final LiveDataLibraryAccessors laccForLiveDataLibraryAccessors = new LiveDataLibraryAccessors(owner);
    ...
    private final PreferencesLibraryAccessors laccForPreferencesLibraryAccessors = new PreferencesLibraryAccessors(owner);
    private final RetrofitLibraryAccessors laccForRetrofitLibraryAccessors = new RetrofitLibraryAccessors(owner);
    private final RoomLibraryAccessors laccForRoomLibraryAccessors = new RoomLibraryAccessors(owner);
    private final TooltingLibraryAccessors laccForTooltingLibraryAccessors = new TooltingLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at hiltNavigation
     */
    public HiltNavigationLibraryAccessors getHiltNavigation() { return laccForHiltNavigationLibraryAccessors; }
    ...
    /**
     * Returns the group of libraries at liveData
     */
    public LiveDataLibraryAccessors getLiveData() { return laccForLiveDataLibraryAccessors; }
    ...
    /**
     * Returns the group of libraries at preferences
     */
    public PreferencesLibraryAccessors getPreferences() { return laccForPreferencesLibraryAccessors; }
    ...
    /**
     * Returns the group of libraries at toolting
     */
    public TooltingLibraryAccessors getToolting() { return laccForTooltingLibraryAccessors; }
    ...
    public static class HiltNavigationLibraryAccessors extends SubDependencyFactory {
        ...
        public HiltNavigationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCompose() { return create("hiltNavigation.compose"); }
    ...
    public static class LiveDataLibraryAccessors extends SubDependencyFactory {

        public LiveDataLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for compose (androidx.compose.runtime:runtime-livedata)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCompose() { return create("liveData.compose"); }
    ...
    public static class MaterialLibraryAccessors extends SubDependencyFactory {
        ...
        public MaterialLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCompose() { return create("material.compose"); }
    ...
    public static class PreferencesLibraryAccessors extends SubDependencyFactory {

        public PreferencesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for ktx (androidx.preference:preference-ktx)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getKtx() { return create("preferences.ktx"); }
    ...
    public static class TooltingLibraryAccessors extends SubDependencyFactory {

        public TooltingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for preview (androidx.compose.ui:ui-tooling-preview)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getPreview() { return create("toolting.preview"); }
    ...
    public static class UiLibraryAccessors extends SubDependencyFactory {
        ...
        public UiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for compose (androidx.compose.ui:ui)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCompose() { return create("ui.compose"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: coilCompose (1.3.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: lifecycle (2.6.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: liveDataCompose (1.3.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: materialCompose (1.3.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: preferenceKtx (1.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: tooltingPreview (1.3.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getTooltingPreview() { return getVersion("tooltingPreview"); }

            /**
             * Returns the version associated to this alias: uiCompose (1.3.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getUiCompose() { return getVersion("uiCompose"); }
    ...
    public static class ComposeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        public Provider<String> asProvider() { return getVersion("compose"); }
            ...
            /**
             * Returns the version associated to this alias: compose.version (1.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
